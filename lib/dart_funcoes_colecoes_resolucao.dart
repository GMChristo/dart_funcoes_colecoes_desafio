void main() {
  ...
  final pessoaSemDuplicado = pessoas.toSet().map((e) => e.split('|').toList());
  pessoaSemDuplicado.forEach((p) => print(p[0]));

  //! 2 - Me mostre a quantidade de pessoas por sexo (Masculino e Feminino) e depois me apresente o nome delas
  final mapSexo = <String, List<String>>{};
  for (var pessoa in pessoaSemDuplicado) {
  ...
  final pessoasMaiores18 = pessoaSemDuplicado.where((p){
  ...
  final pessoaOrdenada = [...pessoaSemDuplicado];
  ...
  print('\nquestao 4\n');
  print('A pessoa mais velha é: ${pessoaMaisVelha[0]} com ${pessoaMaisVelha[1]} anos');
}